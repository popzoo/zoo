...
let coreMsg="popzoo网址运行即将一年，但也即将走入历史，感谢大家一年多的支持与鼓励，有过辉煌的熙熙攘攘，也有过没落的无人问津。现网址www.popzoo.xyz网址于2020-12-12正式闭站，本网址回归为Github的<a href='https://popzoo.github.io/zoo/' style='color:green;' target='_blank'>默认网址</a>https://popzoo.github.io/zoo/，还请大惠存！<br>最后引用金庸先生《神雕侠侣》的结尾词来告别诸位——今番良晤，豪兴不浅，他日江湖相逢，再当杯酒言欢。咱们就此别过……";
document.getElementById("home_main_notice").innerHTML=coreMsg;
// document.getElementById("home_main_notice").style.setAttribute("text-align","center");
